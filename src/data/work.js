...
export const work = [
  {
    ...
    body: 'Consumer systems on web and mobile: a dozen critical APIs serving millions of requests a day. Caching, prefetch, and circuit breakers keep them fast when traffic spikes, and a BFF layer feeds each client what it needs. I led the decomposition of a legacy monolith into microservices: phased, zero downtime, with security hardening along the way.',
    tags: ['kotlin', 'java', 'vert.x', 'react', 'redis', 'caching', 'oauth2', 'bff', 'github-actions', 'jenkins'],
  },
  {
    name: 'Healthcare',
    context: 'telehealth platform · web and mobile',
    body: 'Telehealth and clinical trials. On the telehealth side: event-driven microservices behind care workflows, including the scheduling system I built. A lost event can mean a patient misses care, so delivery guarantees and audit trails get more attention than throughput. On the trials side: patient recruitment platforms for clinical research sites.',
    tags: ['kotlin', 'java', '.net', 'react', 'aws', 'kinesis', 'eventbridge', 'sqs', 'postgresql', 'datadog'],
  },
  {
    name: 'Telecommunications',
    context: 'devices supply chain · data platform',
    body: 'Data platform work for the devices supply chain org. The systems tracked hardware from purchase order to delivery: real-time streams moving hundreds of thousands of events an hour through Kafka, ETL across three warehouse platforms, and a Golang tool that generated pipeline schemas automatically and cut pipeline development time by more than half.',
